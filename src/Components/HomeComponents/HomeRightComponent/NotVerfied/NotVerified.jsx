...
const NotVerified = ({ userInfo }) => {
  ...
  /**
   * todo : handleGoToMail funtion implement
   */

  return (
    <div>
      <div class="h-[96vh] rounded-2xl w-[97vw] bg-gray-100 flex items-center">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
          <div class="max-w-md">
            <div class="text-5xl font-dark font-bold">
              {displayName.toUpperCase()}
            </div>
            <p class="text-2xl md:text-3xl font-light leading-normal pt-7">
              Please Verfied Your Email {email}
            </p>

            <button class="px-4 inline py-2 mt-6 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700">
              <Link
